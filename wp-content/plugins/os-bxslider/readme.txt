...
1. OS BXSlider slider listing interface
2. OS BXSlider add new slider interface
3. OS BXSlider - Slider with captions 
4. OS BXSlider - Carousel 
5. OS BXSlider - Thumbnail 
6. OS BXSlider - Ticker 
