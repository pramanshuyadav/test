=== Live Group Chat - HTML5 ===
Contributors: RumbleTalk Chat
Donate link:
Tags: group chat, chat, chatroom, chat room, text messaging, community chat, video chat, social chat, discussion chat, team chat, html5 chat, chatroom widget, chat plugin, live chat, chat widget
Requires at least: 2.0.2
Tested up to: 4.4.0
Stable tag: 4.7.2

Live group Chat room for your wordpress web site. Over than 462,000 chat rooms created. Share Files, Upload images, video chat...and more

== Description == 

462,000 websites are already using <a href="http://www.rumbletalk.com/">RumbleTalk</a> Chat room, Join NOW!
...
9. Mobile group chat view. Open the chat from anywhere using your mobile or tablet.
...
The FREE trial is limited to 4 simultaneous chatters. The RumbleTalk chat is AD FREE. The Premium version allows you to talk with more simultaneous chatters, live audio calls, video calls, have private chat, moderation rights, css editing, chat archiving and offline mode.
