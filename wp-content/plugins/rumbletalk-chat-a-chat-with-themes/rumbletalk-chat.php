...
<script type="text/javascript" src="<?= $this->cdn ?>api/v0.26/sdk.js"></script>
            <?php
        }
    }
                ...
                <tr>
                    <td width="500" valign="top">
                        ...
                        <div style="width:500px;position;relative;">
                        	<form method="post" action="//www.rumbletalk.com/_ajax_reg_remote.php" onsubmit="return validate_account_creation( this );" id="create_form"<?= get_option("rumbletalk_chat_code") == '' ? '' : ' style="display:none;"' ?>>
	                        	...
	                        	<table valign="top">
									...
									<tr>
										<td colspan="2" style="padding-bottom:15px;">
											Add RumbleTalk chat-room to your web site or blog in one minute.<br/><br/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font:arial 8px none; color:#AAACAD">
                                                This is the 8 letters/signs chat room code you've received from RumbleTalk (after registration you see it in the <a href="<?= $this->cdn ?>images/Instructions-getChat.png" target="_blank"> chat code </a>section in addition to an email send with the code).<br/><br/>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr id="chat_width">
