...
function optionsframework_options() {
   ...
   // HEADER
	...
	$options[] = array(
		...
		$options[] = array('name' => __('Slide 6', 'meris'),'id' => 'slide_group_start_6','type' => 'start_group','class'=>'group_close');
		$options[] = array('name' => __('Image', 'meris'),'id' => 'meris_slide_image_6','type' => 'upload','std'=>MERIS_THEME_BASE_URL.'/images/banner-1.jpg');
		
		$options[] = array('name' => __('Text', 'meris'),'id' => 'meris_slide_text_6','type' => 'editor','std'=>'<h1>It<s>\'</s>s Nice <strong>to meet y<s>o</s>u</strong></h1><button>Tell Me More</button>');
		$options[] = array('name' => __('Link', 'meris'),'id' => 'meris_slide_link_6','type' => 'text');
