...
add_action( 'after_setup_theme', 'meris_setup' );
 ...
 function meris_custom_scripts(){
	 global $is_IE;
	wp_enqueue_style('meris-bootstrap',  get_template_directory_uri() .'/css/bootstrap.min.css', false, '4.0.3', false);
   ...
   $meris_custom_css = "";
	...
	wp_enqueue_script( 'meris-bootstrap', get_template_directory_uri().'/js/bootstrap.min.js', array( 'jquery' ), '3.0.3', true );
	wp_enqueue_script( 'meris-less', get_template_directory_uri().'/js/less.min.js', array( 'jquery' ), '1.4.2', true );
	wp_enqueue_script( 'meris-respond', get_template_directory_uri().'/js/respond.min.js', array( 'jquery' ), '1.4.2', true );
	wp_enqueue_script( 'meris-main', get_template_directory_uri().'/js/meris.js', array( 'jquery' ), '1.0.4', true );
	wp_enqueue_script( 'meris-modernizr', get_template_directory_uri().'/js/modernizr.custom.js', array( 'jquery' ), '2.8.2', true );
