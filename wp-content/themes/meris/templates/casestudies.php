							...
							<div class="col-md-12 ">
								<div class="main-content orange-color">
									<div class="row">
										...
										<div class="col-md-7 col-sm-12 col-xs-12">
											<h3 class="orange-color"><?php echo  get_field('client_case_title'); ?></h3>
											<div class="client-content">
												<?php echo get_field('client_description');  ?>
											</div>
											<div class="testimonial-div">
												<?php echo get_field('testimonial_content');  ?>
												<span class="testimonial-by"><?php echo get_field('testimonial_by');  ?></span>
											</div>
										</div>
										<div class="col-md-5 col-sm-12 col-xs-12">
											<?php echo get_field('right_section_slider_2');?>
										</div>
									</div>
